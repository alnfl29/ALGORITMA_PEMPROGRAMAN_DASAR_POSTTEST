...
print(" <== Selamat Datang di POSTTEST 7 ==> ")

datalogin = {
"list_username" : ["Alif","Naufal"],
"list_password" : ["290604","2964"],
...
while(cek_userpass == False):
    ...
    if(input_username) in datalogin["list_username"] :
        cek_userpass = True
        if(datalogin["list_username"].index(input_username)==datalogin["list_password"].index(input_password)):
            garis()
            print("  login berhasil  ")
            garis()
            os.system("cls")

            get_index = datalogin["list_username"].index(input_username)
            if(datalogin["list_role"][get_index] == "admin"):
                tampilan_admin()
            ...
            elif(datalogin["list_role"][get_index] == "user"):
                tampilan_user()
